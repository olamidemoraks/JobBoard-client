...
const JobCard: React.FC<JobCardProps> = ({
  ...
  console.log(Job);
  return (
    <div className=" bg-gradient-to-t to-gray-200/80 via-white from-[#fff] w-full min-h-[200px] shadow-sm p-4 flex flex-col gap-6 rounded-md border border-gray-300">
      <div
      ...
      >
        ...
        <div className="flex flex-col gap-1 w-[90%]">
          ...
          <div className="flex text-gray-400 font-semibold items-center gap-1 uppercase text-[11px]">
            <IoPeople />
