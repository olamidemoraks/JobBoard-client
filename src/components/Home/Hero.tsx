    ...
    <div className="bg-gradient relative top-0 left-0 right-0 w-[100%] mx-auto  flex items-center overflow-x-hidden  overflow-y-scroll xl:px-[260px] lg:px-[100px]  md:px-[40px] px-[100px]  justify-between pt-[8rem] md:flex-row flex-col-reverse h-screen  lg:gap-[2rem] md:gap-[6rem] sm:gap-[2px] snap-mandatory snap-start">
      <div className="flex flex-col w-full flex-1 items-start mt-1  mb-[6rem]">
        <div className="relative">
          ...
          <div className="w-[60px] h-[40px] absolute left-[22rem]  sm:bottom-10 bottom-14">
            <img
          ...
          <div className="w-[200px] h-[70px] absolute left-[10rem] -bottom-12">
        ...
        <div className="flex gap-7 mt-[3rem]">
          <Link
            href="/jobs"
            className=" px-6 py-4 font-bold rounded-lg bg-light-green w-[160px] text-center hover:bg-[#4dfacc] transition duration-300"
          >
            Find a job
          </Link>
          <Link
            href="/employee"
            className=" bg-mid-green text-white px-6 py-4 font-bold rounded-lg  w-[160px] text-center hover:bg-[#266553] transition duration-300"
          >
            Post Job
          </Link>
        </div>
      </div>
      <div className="flex-1 relative w-full flex justify-end items-center top-0 right-0 lg:translate-x-28 ">
        ...
        <div className="absolute right-0 top-20 group">
          <div className="w-[270px] h-[250px] bg-mid-green absolute translate-x-[7.3rem] -translate-y-20  rounded-[23px] border border-light-green/30 group-hover:translate-x-[8rem] group-hover:-translate-y-[5.2rem] ease-linear duration-300" />
          <div className="w-[300px] h-[300px] bg-dark-green absolute  translate-x-[4.3rem] -translate-y-16 rounded-[23px] border border-light-green/30 group-hover:translate-x-[5rem] group-hover:-translate-y-[4.5rem] ease-linear duration-300" />
          <div className="w-[350px] h-[350px] relative rounded-[23px] -top-12  border border-light-green/30 group-hover:w-[355px] group-hover:h-[355px] ease-linear duration-300">
            <img
      ...
      <input ref={scrollRef} className=" bg-transparent outline-none " />
    </div>
  );
};
export default Hero;
